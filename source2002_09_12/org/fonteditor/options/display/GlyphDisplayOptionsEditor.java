...
public class GlyphDisplayOptionsEditor extends GlyphDisplayOptions implements GlyphDisplayOptionsEditorConstants {
  ...
  public GlyphDisplayOptionsEditor(boolean show_sliders, boolean show_grid, boolean hint, boolean fill, boolean border, boolean show_points, boolean show_springs, Pen pen, CoordsEditor coords) {
    set(show_sliders, show_grid, hint, fill, border, show_points, show_springs, pen, coords);
  }

  public GlyphDisplayOptionsEditor() {
  ...
  public static GlyphDisplayOptions getGDOForScaling() {
    return new GlyphDisplayOptionsEditor(DEFAULT_SHOW_SLIDERS, DEFAULT_SHOW_GRID, false, DEFAULT_FILL, false, false, false, DEFAULT_PEN, DEFAULT_COORDS_EDITOR);
  }

  private static GlyphDisplayOptions getGDOdefaults() {
    return new GlyphDisplayOptionsEditor(DEFAULT_SHOW_SLIDERS, DEFAULT_SHOW_GRID, DEFAULT_HINT, DEFAULT_FILL, false, false, false, DEFAULT_PEN, DEFAULT_COORDS_EDITOR);
  }
  ...
  public static GlyphDisplayOptions getGDOrender(int siz, int aa_sf_x, int aa_sf_y) {
    ...
    return new GlyphDisplayOptionsEditor(false, false, true, false, false, false, false, new PenRound(0), c);
  }
  ...
  public Object clone() throws CloneNotSupportedException {
    // super.clone();
    return new GlyphDisplayOptionsEditor(show_sliders, show_grid, isHint(), isFill(), border, show_points, show_springs, getPen(), (CoordsEditor) getCoordsEditor().clone());
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof GlyphDisplayOptionsEditor)) {
      return false;
    }

    GlyphDisplayOptionsEditor gdo = (GlyphDisplayOptionsEditor) o;
