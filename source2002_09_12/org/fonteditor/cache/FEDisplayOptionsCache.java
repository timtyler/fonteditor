...
public class FEDisplayOptionsCache {
  ...
  public FEGlyphCache getFEGlyphCache(GlyphDisplayOptions gdo) {
    return (FEGlyphCache) hashtable.get((Object) gdo);
  }

  CachedGlyph getCachedGlyph(GlyphDisplayOptions gdo, char c) {
  ...
  void remove(GlyphDisplayOptions gdo, char c) {
