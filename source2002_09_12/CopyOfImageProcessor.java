...
//private final static int ROTATE_CW  = 1;
//private final static int ROTATE_180 = 2;
//private final static int ROTATE_ACW = 3;
//private final static int HFLIP      = 4;
//private final static int VFLIP      = 5;
//private final static int HFLIP_CW   = 6;
//private final static int HFLIP_ACW  = 7;
//
...
//    */
//private static TTImage rotate(TTImage _i) {
...
//    */
//private static TTImage affine(TTImage _i, int type) {
...
//            }
//         }
//         return new TTImage(pixels_out, h, w);
//   
//      case ROTATE_ACW:
//         for (int i = 0; i < w; i++) {
//            for (int j = 0; j < h; j++) {
...
//    * Returns a new image.
//    */
//private static TTImage simpleIntensityFilter(TTImage _i, int m) {
...
//    * Returns a new image.
//    */
//private static TTImage addNoise(TTImage _i, int m) {
//   int[] image_pix = _i.getArray();
//   int w = _i.getWidth();
//   int h = _i.getHeight();
//
...
//    * Returns a new image.
//    */
//private static TTImage invertingFilter(TTImage _i, boolean ir, boolean ig, boolean ib) {
//   int[] image_pix = _i.getArray();
//   int w = _i.getWidth();
//   int h = _i.getHeight();
//
...
//    * Returns a new image.
//    */
//private static TTImage HSBFilter(TTImage _i, float _h, float _s, float _b, boolean set_h, boolean set_s, boolean set_b) {
...
//    * Returns a new image.
//    */
//private static TTImage mask(TTImage _i, TTImage _m, float weight_h, float weight_s, float weight_b, boolean mask_a) { // float _h, float _s, float _b, boolean set_h, boolean set_s, boolean set_b) {
//   float[] hsb = new float[3];
...
//    */
//static TTImage scale(TTImage _i, int x_scale, int y_scale) {
...
//   }
//
//   return new TTImage(pixels_out, w2, h2);
//}
//
//
//   /**
...
//    * scale factors = 1024 => normal size...
//    */
//private static TTImage scaleSlow(TTImage _i, int x_scale, int y_scale) {
//   int w = _i.getWidth(null);
//   int h = _i.getHeight(null);
//
//   int w2 = (w * x_scale) >> 10;
...
//private static TTImage combineTwoImages(TTImage i_bot, TTImage i_top) {
//   if (i_bot == null) { Log.log("texture == null"); }
//   if (i_bot == null) { Log.log("mask == null"); }
...
//
//
//private static TTImage combineTwoImagesInternally(TTImage i_bot, TTImage i_top, int w, int h, int[] pixels_out) {
...
//
//// Only uses binary alpha channel at the moment :-(
//private static TTImage combineTwoImagesWithFullOverwrite(TTImage i_bot, TTImage i_top) {
//   if (i_bot == null) { Log.log("texture == null"); }
//   if (i_bot == null) { Log.log("mask == null"); }
//   int w = i_bot.getWidth(null);
//   int h = i_bot.getHeight(null);
...
//
//
//private static TTImage combineTwoImagesWithFullOverwriteInternally(TTImage i_bot, TTImage i_top, int w, int h, int[] pixels_out) {
////PixelArrays.ensureArray3Size(w * h);
////int[] pixels3 = PixelArrays.pixels3;
////PixelArrays.ensureArray4Size(w * h);
////int[] pixels4 = PixelArrays.pixels4;
...
//
//
//private static TTImage applyMaskToImage(TTImage texture, TTImage mask) {
...
//
//// texture , mask
//private static TTImage applyMaskToImageInternally(TTImage texture, TTImage mask, int w, int h, int[] pixels_out) {
////if (texture == null) { Log.log("texture == null"); }
////if (mask == null) { Log.log("mask == null"); }
////int w = texture.getWidth(null);
////int h = texture.getHeight(null);
...
//private static int[] imageToArray(TTImage i) { // , int[] ia) {
//   if (i == null) {
