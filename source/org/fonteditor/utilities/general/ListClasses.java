...
/**
 * Used for making the configuration file for JAX - IBM's deployment tool
 * This requires a complete list of classes in the project.
 */

public class ListClasses {
  // ***WARNING*** HARDWIRED PATH!!
