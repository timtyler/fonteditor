...
public class CharacterGrid extends Canvas {
  ...
  public CharacterGrid() {
    ...
    gdo = font_renderer.getGDO(2, 1, new PenRound(0x0), true);
    validate();
    repaint();
  }
  ...
  // OPTIMISE
  private void removeCharacterFromCache(GlyphDisplayOptions gdo, char c) {
  ...
  public void makeDefault(GlyphDisplayOptionsEditor gdoe, int width, int height, boolean preserve_aspect_ratio) {
