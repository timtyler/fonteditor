...
public class FEGlyphCache {
  ...
  CachedGlyph getCachedGlyph(char c, FEFont fefont, GlyphDisplayOptions gdo) {
    if (c >= size) {
  ...
  private void makeGlyph(char c, FEFont fefont, GlyphDisplayOptions gdo) {
    ...
    if (i != null) {
      ...
      image = FontImageProcessor.fontScale(tti, scale_factor_x, scale_factor_y);
