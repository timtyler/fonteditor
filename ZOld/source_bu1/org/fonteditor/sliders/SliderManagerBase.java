...
public class SliderManagerBase {
  private SliderBase[] new_array;
  private static final int INCREMENT = 8;
  private int number = 0;
  private int max_number = 0;
  private SliderBase[] array = new SliderBase[max_number];

  void add(SliderBase base) {
  ...
  private void makeMore() {
    new_array = new SliderBase[max_number + INCREMENT];
  ...
  public final int compare(Object a, Object b) {
        ...
        return ((SliderBase) a).compareTo((SliderBase) b);
      }
  ...
  void dedupe() {
    ...
    if (number > 1) {
      ...
      for (int i = 1; i < number; i++) {
        ...
        SliderBase s2 = array[out_index - 1];
  ...
  public void select(int position) {
    for (int i = 0; i < number; i++) {
      if (Utils.abs(array[i].getPosition() - position) < 0x200) {
  ...
  public SliderBase getSlider(int i) {
    return array[i];
  }
}
