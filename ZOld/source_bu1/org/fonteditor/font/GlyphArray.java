...
public class GlyphArray {
  ...
  public int getMinX(int min, int max, GlyphDisplayOptions gdo) {
  ...
  public int getMinY(int min, int max, GlyphDisplayOptions gdo) {
  ...
  public int getMaxX(int min, int max, GlyphDisplayOptions gdo) {
  ...
  public int getMaxY(int min, int max, GlyphDisplayOptions gdo) {
  ...
  public void showCharsWithX(int min, int max, int x, GlyphDisplayOptions gdo) {
    for (int i = min; i < max; i++) {
  ...
  public void showCharsWithY(int min, int max, int y, GlyphDisplayOptions gdo) {
    for (int i = min; i < max; i++) {
